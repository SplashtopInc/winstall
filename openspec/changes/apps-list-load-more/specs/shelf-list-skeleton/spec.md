...
#### Scenario: 打开 /apps 先看到骨架

- **WHEN** 用户打开 `/apps` 或 `/apps?q=` 结果且第一批应用尚未返回
- **THEN** 页面展示与应用网格同结构的占位卡，而不是仅一行 Loading 文案
