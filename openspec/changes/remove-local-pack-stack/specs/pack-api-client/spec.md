...
Homepage recommended or official packs, the packs sitemap, and any other SSR or build-time Pack reads MUST obtain Pack data from winstall-api using server-side credentials. They MUST NOT query a local Pack collection as authority.
